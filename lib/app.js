...
const isAxiosError = err => err.response || err.request
  ...
  try {
    ...
    const renderApp = (req, res) => {
      ...
      renderer.renderToString(context, (err, html) => {
        if (config.extendResponse) {
          config.extendResponse({ context, html, err, req, res })
        }
        if (context.redirect) {
